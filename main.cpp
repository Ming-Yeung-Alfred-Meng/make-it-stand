...
// Code adopted from: https://github.com/alecjacobson/geometry-processing-deformation/blob/master/main.cpp
...
⌘ ⇧ Z    Redo
  ...
  const auto & update = [&]()
  {
      ...
      if(s.state == 0) {
        ...
        inner_carving(U, F, Eigen::Vector3d(0, -1, 0), s.CU.row(s.contact), voxel_scale, min_carve, thickness, density, MiV, MiF);
